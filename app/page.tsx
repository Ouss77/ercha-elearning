        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Découvrez une large gamme de cours conçus par des experts pour
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-border/50 bg-card hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 group overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  Chapitres avec vidéos, textes, images et liens pour un
                  apprentissage complet et engageant
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border/50 bg-card hover:shadow-xl hover:shadow-chart-2/10 transition-all duration-300 group overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  Administration intuitive des étudiants, professeurs et
            ...
            <Card className="border-border/50 bg-card hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 group overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  Tableaux de bord détaillés pour suivre l'avancement et
            ...
            <Card className="border-border/50 bg-card hover:shadow-xl hover:shadow-chart-2/10 transition-all duration-300 group overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  Quiz interactifs et projets finaux pour valider vos
          ...
          <Card className="max-w-3xl mx-auto border-primary/20 bg-card/80 backdrop-blur-sm shadow-2xl">
            ...
            <CardContent className="pb-8">
              {user ? (
                <Button
                  size="lg"
                  className="px-10 bg-primary hover:bg-primary/90 shadow-xl shadow-primary/30"
                  asChild
                >
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Transformez votre avenir avec notre plateforme d'apprentissage
                moderne
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-border pt-8 text-center">
            <p className="text-muted-foreground text-sm">
              © 2025 EduPlatform. Tous droits réservés. Plateforme
